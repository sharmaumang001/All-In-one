...
public class HomeActivity extends AppCompatActivity {
   ...
   void payUsingUpi(  String name,String upiId, String note, String amount) {
       ...
       Uri uri = Uri.parse("upi://pay").buildUpon()
                ...
                //.appendQueryParameter("refUrl", "Myapp")
                .build();
        ...
        if(null != chooser.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(HomeActivity.this,"No UPI app found, please install one to continue",Toast.LENGTH_SHORT).show();
        }
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(HomeActivity.this)) {
            ...
            if (status.equals("success")) {
                ...
                Toast.makeText(HomeActivity.this, "Transaction successful.", Toast.LENGTH_SHORT).show();
                Log.e("UPI", "payment successfull: "+approvalRefNo);
            }
            else if("Payment cancelled by user.".equals(paymentCancel)) {
                Toast.makeText(HomeActivity.this, "Payment cancelled by user.", Toast.LENGTH_SHORT).show();
                Log.e("UPI", "Cancelled by user: "+approvalRefNo);

            }
            else {
                Toast.makeText(HomeActivity.this, "Transaction failed.Please try again", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(HomeActivity.this, "Internet connection is not available. Please check and try again", Toast.LENGTH_SHORT).show();
        }
    }
